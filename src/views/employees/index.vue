  ...
  <div class="dashboard-container">
    ...
    <el-card v-loading="loading">
        ...
        <!-- 表格中如何显示序号 -->
          ...
          <el-table-column label="姓名" sortable="" props="username" />
          <el-table-column label="工号" sortable="" props="workNumber" />
...
import EmployEnum from '@/api/constant/employees' // 引入员工的枚举对象
...
export default {
  ...
  methods: {
    ...
    formatEmployment(row, column, cellValue, index) {
      // 要去找1所对应的值
      const obj = EmployEnum.hireType.find(item => item.id === cellValue)
