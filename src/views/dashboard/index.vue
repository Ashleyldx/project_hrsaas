<template>
  <div class="dashboard-container">
    ...
    <el-row type="flex" justify="space-between">
      ...
      <el-col :span="11">
        <el-card class="box-card">
          ...
          <div class="sideNav">
            <el-button class="sideBtn" @click="lizhiClick">加班离职</el-button>
   ...
   <lizhi :dialog-visible.sync="visibleDialog"></lizhi>
  </div>
</template>
...
export default {
  name: 'Dashboard',
  components: { workCalender, Radar, lizhi },
  // directives 局部注册自定义指令
  directives: {
    color: {
      inserted(dom, options, vNode) {
        console.log(dom) // dom 指令绑定元素
        console.log(options) // 描述当前指令信息;
        console.log(vNode.context) // 可以访问到当前的vue实例;
        // 实现更改当前的dom 元素
